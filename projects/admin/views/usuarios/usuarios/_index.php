                            ...
                            <table class="table table-bordered no-footer dataTable">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting"
                                        ...
                                        rowspan="1" colspan="1">E-mail
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_tipo') ?>', '_self');"
                                        rowspan="1" colspan="1">Tipo
                                    </th>
                                    <th class="sorting"
                                ...
                                foreach ($models as $model) {
                                    ...
                                    <tr role="row" class="even">
                                        <td><?= $model->nome ?></td>
                                        <td><?= $model->email ?></td>
                                        <td><?= $model->tipo == 0 ? 'Administrador' : 'Comum' ?></td>
                                        <td>
