                        ...
                        <div class="datatable-header">
                            <form action="<?= \Admin::buildGetUrl() ?>" method="get" name="form_list">
                                ...
                                <div class="dt-buttons">
                                    <a class="dt-button btn bg-teal-400" id="gem_pdf_dia">
                                        <span>Gerar PDF de separação de estoque físico</span>
                                    </a>
                                </div>
                                ...
                                <tr role="row">
                                    <th>
                                        ...
                                        <div style="text-align: center;" class="checkbox">
                                            <div>
                                                <input id="select_all" type="checkbox"><label for="select_all">
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                foreach ($models as $model) {
                                    ...
                                    <tr <?= $style ?> data-status="<?= $model->status ?>" data-id="<?= $model->primaryKey() ?>"
                                        ...
                                        <td>
                                            <div style="text-align: center;" class="checkbox">
                                                <div>
                                                    <input name="id_pedido" value="<?= $model->primaryKey() ?>" id="select_<?= $model->primaryKey() ?>" type="checkbox"><label for="select_<?= $model->primaryKey() ?>">
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <input name="metodo_pagamento" value="<?= $model->metodo_pagamento ?>" type="hidden"/>
                                            <input name="observacoes" value="<?= brtonl($model->observacoes) ?>" type="hidden"/>
                                            <input name="valor_frete" value="<?= Formater::intToCurrency($model->valor_frete) ?>" type="hidden"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea style="height: 100px;" class="form-control" id="observacoes" name="observacoes"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <div class="col-lg-12">
