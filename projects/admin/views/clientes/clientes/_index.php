                            ...
                            <table class="table table-bordered no-footer dataTable">
                                ...
                                <tr role="row">
                                    <th class="sorting"
                                        ...
                                        rowspan="1" colspan="1">Responsável
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_nome_fantasia') ?>', '_self');"
                                        rowspan="1" colspan="1">Nome fantasia
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_razao_social') ?>', '_self');"
                                        rowspan="1" colspan="1">Razão social
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_email') ?>', '_self');"
                                        rowspan="1" colspan="1">E-mail do responsável
                                    </th>
                                    <!--th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_inscricao_estadual') ?>', '_self');"
                                        rowspan="1" colspan="1">Inscrição estadual
                                    </th-->
                                    <!--th class="sorting"
                                    ...
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_cnpj') ?>', '_self');"
                                        rowspan="1" colspan="1">CNPJ
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_cpf') ?>', '_self');"
                                        rowspan="1" colspan="1">CPF
                                    </th>
                                    <!--th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_rg') ?>', '_self');"
                                        rowspan="1" colspan="1">RG
                                    </th-->
                                    <th class="sorting"
                                ...
                                foreach ($models as $model) {
                                    ...
                                    <tr role="row" class="even">
                                        ...
                                        <td><?= $model->cnpj != '' ? $model->cnpj : 'Pessoa física' ?></td>
                                        <td><?= $model->cpf != '' ? $model->cpf : 'Pessoa jurídica' ?></td>
                                        <!--td><?= $model->rg ?></td-->
                                        <td>
                                            <span class="label label-<?= $model->status == 0 ? 'danger' : 'success' ?>">
                                                <?= $model->status == 0 ? 'Inativo' : 'Ativo' ?>
                                            </span>
                                        </td>
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                <button
                                                    onclick="redirectTo('<?= \Admin::buildUrlNoPage('enderecos_clientes/page/1/' . $model->primaryKey()) ?>', '<?= \Admin::buildGetUrl() ?>')"
                                                    class="btn bg-blue-400"
                                                    data-popup="tooltip" data-placement="left" title=""
                                                    data-original-title="Endereços">
                                                    <i class="icon-pin"></i>
                                                </button>
                                            </div>
                                            <a href="javascript:;"
