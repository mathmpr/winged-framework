                        ...
                        <div class="datatable-scroll-wrap">
                            <table class="table table-bordered no-footer dataTable">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_categoria') ?>', '_self');"
                                        rowspan="1" colspan="1">Categoria
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_subcategoria') ?>', '_self');"
                                        rowspan="1" colspan="1">Subcategoria
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_cod_barras') ?>', '_self');"
                                        rowspan="1" colspan="1">Código de barras
                                    </th>
                                    <!--th class="sorting"
                                    ...
                                    <!--th class="sorting"
                                        ...
                                        rowspan="1" colspan="1">Valor minimo
                                    </th>
                                    <th class="sorting"
                                    ...
                                    <th rowspan="1" colspan="1" style="width:180px">Editar</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                /**
                                 * @var $models array | Produtos[]
                                 * @var $model Produtos
                                 */
                                foreach ($models as $model) {
                                    ...
                                    <tr role="row" class="even">
                                        <td><?= $model->nome ?></td>
                                        <td><?= $model->extra()->categoria ?></td>
                                        <td><?= $model->extra()->subcategoria == '' ? 'Não informada' : $model->extra()->subcategoria ?></td>
                                        <td><?= $model->cod_barras ?></td>
                                        <!--td><?= $model->valor_unitario ?></td-->
                                        <td><?= $model->valor_atacado ?></td>
                                        <!--td><?= $model->valor_minimo ?></td>
                                        <td><?= $model->valor_de_custo ?></td-->
                                        <td><?= $model->quantidade_estoque ?></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <button
                                                    ...
                                                    class="add-cart btn bg-blue-400"
                                                    data-popup="tooltip" data-placement="top" title=""
                                                    data-original-title="Adicionar ao carrinho">
