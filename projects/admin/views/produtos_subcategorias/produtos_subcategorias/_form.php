                    ...
                    <div class="content-wrapper">
                        <div class="content">
                            <div class="row">
                                ...
                                <?php
                                if ($model->primaryKey()) {
                                    echo $form->addInput(ProdutosSubcategorias::primaryKeyName(), 'Input', ['type' => 'hidden']);
                                }
                                if (\Admin::isInsert()) {
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">Subcategorias dos produtos</h5>
                                        <div class="panel-body">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        ?>
                                                        <?php $options = array2htmlselect((new ProdutosCategorias())
                                                            ->select()
                                                            ->from(['CATEGORIAS' => 'produtos_categorias'])
                                                            ->orderBy(ELOQUENT_ASC, 'CATEGORIAS.nome')
