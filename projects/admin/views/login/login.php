        ...
        <div class="content-wrapper">
            <div class="content">
                <div class="panel panel-body login-form">
                    ...
                    <?= $form->begin('', 'post', ['id' => 'login'], 'multipart/form-data', true); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button id="make-login" type="submit" class="btn btn-primary btn-block">Entrar
                                <span>
                        ...
                        <div class="text-center">
                            ...
                            <br><br>
                            <a href="login/forgot">Esqueci a senha</a>
                        </div>
                    </div>
