                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
                        ...
                        <div class="datatable-scroll-wrap">
                            <table class="table table-bordered no-footer dataTable">
                                ...
                                <tr role="row">
                                    <th class="sorting"
                                        onclick="window.open('<?= Admin::buildGetUrlSorting('sort_page_title') ?>', '_self');"
                                        rowspan="1" colspan="1">H1 da Página
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= Admin::buildGetUrlSorting('sort_slug') ?>', '_self');"
                                        rowspan="1" colspan="1">Nome na URL
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= Admin::buildGetUrlSorting('sort_keywords') ?>', '_self');"
                                        rowspan="1" colspan="1">Palavra chave
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= Admin::buildGetUrlSorting('sort_canonical_url') ?>', '_self');"
                                        rowspan="1" colspan="1">URL Canonica
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= Admin::buildGetUrlSorting('sort_fb_title') ?>', '_self');"
                                        rowspan="1" colspan="1">Título para o Facebook
                                    </th>
                                ...
                                foreach ($models as $model) {
                                    ...
                                    <tr role="row" class="even">
                                        ...
                                        <td><?= $model->canonical_url ?></td>
                                        <td><?= $model->fb_title ?></td>
                                        <td>
