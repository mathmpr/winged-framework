                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="lt-buttons">
                                <a class="lt-button btn bg-teal-400" onclick="redirectTo('<?= \Admin::buildUrlNoPage($this->insert) ?><?= uri('id_cliente') ?>', '<?= \Admin::buildGetUrl() ?>')">
                    ...
                    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
                        <div class="datatable-header">
                            <form action="<?= \Admin::buildGetUrl() ?>" method="get" name="form_list">
                                ...
                                <div class="dt-buttons">
                                    <a class="dt-button btn bg-teal-400" onclick="redirectTo('<?= \Admin::buildUrlNoPage($this->insert) ?><?= uri('id_cliente') ?>', '<?= \Admin::buildGetUrl() ?>')">
                                        <span>Adicionar  <i class=" icon-plus-circle2"></i></span>
                                    </a>
                                </div>
                        ...
                        <div class="datatable-scroll-wrap">
                            <table class="table table-bordered no-footer dataTable">
                                ...
                                <tr role="row">
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_estado') ?>', '_self');"
                                        rowspan="1" colspan="1">Estado
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_cidade') ?>', '_self');"
                                        rowspan="1" colspan="1">Cidade
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_bairro') ?>', '_self');"
                                        rowspan="1" colspan="1">Bairro
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_endereco') ?>', '_self');"
                                        rowspan="1" colspan="1">Endereço
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_numero') ?>', '_self');"
                                        rowspan="1" colspan="1">Número
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_complemento') ?>', '_self');"
                                        rowspan="1" colspan="1">Complemento
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_codigo_postal') ?>', '_self');"
                                        rowspan="1" colspan="1">Código postal
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_principal') ?>', '_self');"
                                        rowspan="1" colspan="1">Principal
                                    </th>
                                    <th class="sorting"
                                        onclick="window.open('<?= \Admin::buildGetUrlSorting('sort_data_cadastro') ?>', '_self');"
                                        rowspan="1" colspan="1">Data de cadastro
                                    </th>
                                ...
                                <?php
                                /**
                                 * @var $models array | EnderecosClientes[]
                                 * @var $model EnderecosClientes
                                 */
                                foreach ($models as $model) {

                                    ?>
                                    <tr role="row" class="even">
                                        <td><?= $model->extra()->estado ?></td>
                                        <td><?= $model->extra()->cidade ?></td>
                                        ...
                                        <td>
                                            <span class="label label-<?= $model->principal == 0 ? 'danger' : 'success' ?>">
                                                <?= $model->principal == 0 ? 'Secundário' : 'Primário' ?>
                                            </span>
                                        </td>
