...
class EstadosController extends Controller
{
    public function __construct()
    {
        ...
        $this->dynamic('page_name', 'Estados');
        $this->dynamic('page_action_string', 'Listando');
        $this->dynamic('list', 'estados/');
        $this->dynamic('insert', 'estados/insert/');
        $this->dynamic('update', 'estados/update/');
    }
    ...
    public function actionPage()
    {
        ...
        $links = 3;
        $model->select()->from(['ESTADOS' => 'estados']);
