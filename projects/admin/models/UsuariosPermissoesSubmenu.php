 ...
 **/
class UsuariosPermissoesSubmenu extends Model
{
    /**
     * UsuariosPermissoesSubmenu constructor.
     */
    ...
    {
        return "usuarios_permissoes_submenu";
    }
    ...
    {        
        if($pk && (is_int($pk) || intval($pk) != 0)){
            $this->id_perm_submenu = $pk;
            return $this;        
        }        
        return $this->id_perm_submenu;    
    }
